...
Criterio	Puntos
Menú funcional con switch y while	10
Validaciones con if/else	10
Métodos correctamente definidos	20
Método recursivo sumarNotas	10
Uso de arreglos y colecciones	20
Jerarquía de clases POO	20
Código limpio y buenas prácticas	10
Total	100
Entregables
Proyecto Java en carpeta con nombre RetoPOO_[TuNombre] o Github Folder
Todas las clases en archivos .java separados
El main en una clase llamada Main.java
Comentario al inicio de cada método explicando qué hace
Bonus (sin puntaje extra, solo para los valientes)
Mostrar una tabla formateada con printf al listar estudiantes
Ordenar la lista de estudiantes por nota de mayor a menor usando Collections.sort()
